...
class UploadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _FeaturePlaceholderScreen(
      ...
      message:
          'This screen will let users record or select a sign video, enter the word, and add country or region information.',
      nextStep: 'Next build task: add video picker and upload form.',
    );
  }
}
