...
class RecognitionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _FeaturePlaceholderScreen(
      title: 'Recognize a Sign',
      icon: Icons.pan_tool_alt_rounded,
      message:
          'This screen will eventually compare a recorded sign against uploaded examples and show the closest matching word.',
      nextStep:
          'Next build task: start with 5 to 10 controlled demo words and show top 3 matches.',
    );
  }
}
